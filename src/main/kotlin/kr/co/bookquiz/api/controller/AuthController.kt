...
class AuthController(
    ...
    @PostMapping("/refresh")
    fun refresh(@Valid @RequestBody refreshTokenRequest: RefreshTokenRequest): ResponseEntity<ApiResponse<RefreshTokenResponse>> {
    ...
    @PostMapping("/signup")
    fun signup(@Valid @RequestBody signupRequest: SignupRequest): ResponseEntity<ApiResponse<SignupResponse>> {
    ...
    fun checkPhoneNumberAvailability(@RequestParam phoneNumber: String): ResponseEntity<ApiResponse<Map<String, Boolean>>> {
