...
-- join tables removed in later migration
CREATE TABLE books (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
-- persons table removed in later migration
...
-- persons unique constraint removed in later migration
...
-- join table FKs removed in later migration
