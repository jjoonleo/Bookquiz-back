...
(
    ...
    CONSTRAINT pk_multiplechoiceoption PRIMARY KEY (id)
);
...
(
    ...
    CONSTRAINT pk_multiplechoicequiz PRIMARY KEY (id)
);

CREATE TABLE multiple_choice_user_answer
(
    id          BIGINT  NOT NULL,
    user_answer INTEGER NOT NULL,
    CONSTRAINT pk_multiplechoiceuseranswer PRIMARY KEY (id)
);
...
(
    ...
    CONSTRAINT pk_subjectivequiz PRIMARY KEY (id)
);

CREATE TABLE subjective_user_answer
(
    id          BIGINT NOT NULL,
    user_answer TEXT   NOT NULL,
    CONSTRAINT pk_subjectiveuseranswer PRIMARY KEY (id)
);
...
(
    ...
    CONSTRAINT pk_truefalsequiz PRIMARY KEY (id)
);

CREATE TABLE true_false_user_answer
(
    id          BIGINT  NOT NULL,
    user_answer BOOLEAN NOT NULL,
    CONSTRAINT pk_truefalseuseranswer PRIMARY KEY (id)
);
...
ALTER TABLE multiple_choice_option
    ADD CONSTRAINT FK_MULTIPLECHOICEOPTION_ON_QUIZ FOREIGN KEY (quiz_id) REFERENCES multiple_choice_quiz (id);

ALTER TABLE multiple_choice_quiz
    ADD CONSTRAINT FK_MULTIPLECHOICEQUIZ_ON_ID FOREIGN KEY (id) REFERENCES quiz (id);

ALTER TABLE multiple_choice_user_answer
    ADD CONSTRAINT FK_MULTIPLECHOICEUSERANSWER_ON_ID FOREIGN KEY (id) REFERENCES user_answer (id);
...
ALTER TABLE quiz
    ADD CONSTRAINT FK_QUIZ_ON_BOOK FOREIGN KEY (book_id) REFERENCES books (id);

ALTER TABLE subjective_quiz
    ADD CONSTRAINT FK_SUBJECTIVEQUIZ_ON_ID FOREIGN KEY (id) REFERENCES quiz (id);

ALTER TABLE subjective_user_answer
    ADD CONSTRAINT FK_SUBJECTIVEUSERANSWER_ON_ID FOREIGN KEY (id) REFERENCES user_answer (id);

ALTER TABLE true_false_quiz
    ADD CONSTRAINT FK_TRUEFALSEQUIZ_ON_ID FOREIGN KEY (id) REFERENCES quiz (id);

ALTER TABLE true_false_user_answer
    ADD CONSTRAINT FK_TRUEFALSEUSERANSWER_ON_ID FOREIGN KEY (id) REFERENCES user_answer (id);

ALTER TABLE user_answer
    ADD CONSTRAINT FK_USERANSWER_ON_QUIZ FOREIGN KEY (quiz_id) REFERENCES quiz (id);

ALTER TABLE user_answer
    ADD CONSTRAINT FK_USERANSWER_ON_USER FOREIGN KEY (user_id) REFERENCES users (username);
