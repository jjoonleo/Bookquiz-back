...
ALTER TABLE illustrator
    ADD CONSTRAINT uc_illustrator_name UNIQUE (name);

ALTER TABLE translator
    ADD CONSTRAINT uc_translator_name UNIQUE (name);
...
ALTER TABLE book_illustrator
    ADD CONSTRAINT fk_booill_on_illustrator FOREIGN KEY (illustrator_id) REFERENCES illustrator (id);

ALTER TABLE book_translator
    ADD CONSTRAINT fk_bootra_on_book FOREIGN KEY (book_id) REFERENCES books (id);

ALTER TABLE book_translator
    ADD CONSTRAINT fk_bootra_on_translator FOREIGN KEY (translator_id) REFERENCES translator (id);
