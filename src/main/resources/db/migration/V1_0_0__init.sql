...
(
    ...
    max_words      INTEGER,
    CONSTRAINT pk_subjective_answers PRIMARY KEY (id)
);
...
ALTER TABLE answers
    ADD CONSTRAINT uc_answers_quiz UNIQUE (quiz_id);
...
ALTER TABLE answers
    ADD CONSTRAINT FK_ANSWERS_ON_QUIZ FOREIGN KEY (quiz_id) REFERENCES quiz (id);
...
ALTER TABLE subjective_answers
    ADD CONSTRAINT FK_SUBJECTIVE_ANSWERS_ON_ID FOREIGN KEY (id) REFERENCES answers (id);
...
ALTER TABLE multiple_choice_options
    ADD CONSTRAINT fk_multiple_choice_options_on_multiple_choice_answer_entity FOREIGN KEY (answer_id) REFERENCES multiple_choice_answers (id);

ALTER TABLE quiz_options
    ADD CONSTRAINT fk_quiz_options_on_multiple_choice_quiz FOREIGN KEY (quiz_id) REFERENCES multiple_choice_quiz (id);

ALTER TABLE subjective_possible_answers
    ADD CONSTRAINT fk_subjective_possible_answers_on_subjective_answer_entity FOREIGN KEY (answer_id) REFERENCES subjective_answers (id);
